...
<body>
  ...
  <div id="content" role="main">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="nav">
          <div class="logout col-md-1 col-md-offset-10">
            <a href="/LibraryManagementSys/WebPage/logout/logout.jsp">logout</a>
          </div>
          <div class="userinfo col-md-1">
            <form action="">
              <button class="user-info-button">
                <span class="glyphicon glyphicon-user" aria-hidden="true"><% if(session.getAttribute("userId")!= null) {out.print(session.getAttribute("userId"));} %></span>
              </button>
            </form>
          </div>
        </div>
        ...
        <div class="power-search col-md-2 col-md-offset-5">
                <a href="/LibraryManagementSys/WebPage/search/search.jsp"><button class="btn btn-primary btn-block" id="power-search-button">普通搜索</button></a>
       	</div>
      </div>
    </div>
